...
def audio_processing_thread(input_queue,output_queue,save_queue):
	...
	notes_current = pd.DataFrame([
		('C1',  32.70, ([0,100,255], [255,255,0])),
		('C1#', 34.65, ([255,0,10], [0,100,255])),
		('D1',  36.71, ([255,80,10], [255,0,10])),
		('D1#', 38.89, ([0,255,30], [255,80,10])),
		('E1',  41.20, ([169,3,252], [0,255,30])),
		('F1',  43.65, ([81,255,0], [169,3,252])),
		('F1#', 46.25, ([0,234,255], [81,255,0])),
		('G1',  49.00, ([51,0,255], [0,234,255])),
		('G1#', 51.91, ([255,0,255], [51,0,255])),
		('A1',  55.00, ([255,255,0], [255,0,255])),
		('A1#', 58.27, ([200,255,50], [255,255,0])),
		('B1',  61.74, ([50,100,255], [200,255,50]))])
